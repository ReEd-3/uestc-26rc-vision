...
: ${AMENT_CURRENT_PREFIX:="/run/media/lw3/新加卷/Emb_Sys/projects/26rcteam1/vision/ros2_ws/install/base"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/base/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/base/environment/path.sh"
